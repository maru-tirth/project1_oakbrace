  ...
  <div>
    ...
    <div>
      <v-parallax
        class="img"
        dark
        src="https://oakbrace.co.uk/img/banner_services6_desktop.587026ad.jpg"
      >
        <v-row align="center" justify="center">
          <v-col class="text-center" cols="12">
            <h1 class="text-h4 font-weight-bold mb-4 text">KITCHEN FIT-OUTS</h1>
          </v-col>
        </v-row>
      </v-parallax>
    </div>
    <v-row class="mt-1">
      <v-col
        ...
        md="6"
      >
        <h1 class="mt-1" style="padding: 5%">Kitchen Fit-outs</h1>
        ...
        <p class="p3" style="padding: 5%">
          Our skilled team of installation technicians work to an impeccable
          standard, offering the full package which includes free consultation
          and a dedicated designer to help create and design your kitchen
          completely unique to you and your lifestyle.
        </p>
        <br />
        <p class="p3" style="padding: 5%">
          Oakbrace Limited are familiar with all types of fit-outs but we
          usually work with more high end kitchen manufacturers.
        </p>
      </v-col>
      <v-col style="padding: 0" cols="12" md="6">
        <img
          height="590px"
          width="100%"
          src="	https://oakbrace.co.uk/img/services6_1_mobile.9bd52a03.jpg"
        />
      </v-col>
    </v-row>
    <!-- footer -->
